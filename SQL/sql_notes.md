...
__ACID__ - Набор требований, обеспечивающий сохранность данных
	- Atomicity (Атомарность) - гарантирует что транзакция будет выполнена полностью или не выполнена совсем
 	- Consistency (Согласованность) - консистентность
  	- Isolation (изолированость) - паралельные транзакции не должны оказывать влияние
   	- Durability (надежность) - если получили что транзакция выполнена - пользователь уверен, что изменения не будут отменены
...
__Оконная функция__ - функция, которая работает с выделенным набором строк(окно, партиция)(результирующий набор?) и выполняет вычисление в отдельном столбце. (group by уменьшает кол-во строк, а window не уменьшает). Можно определять в SELECT или в ключевом слове WINDOW. Бывают агрегирующие, ранжирующие и смещения

__Партиция__ -  это набор записей в таблице, объединенных по какому-либо критерию
...
Можно определять в SELECT или в ключевом слове WINDOW
...
bcm2835-isp: Device node output[0] registered as /dev/video20
[   14.352181] bcm2835-isp bcm2835-isp: Device node capture[0] registered as /dev/video21
[   14.352339] bcm2835-codec bcm2835-codec: Device registered as /dev/video12
[   14.352359] bcm2835-codec bcm2835-codec: Loaded V4L2 isp
[   14.352406] bcm2835-isp bcm2835-isp: Device node capture[1] registered as /dev/video22
[   14.352555] bcm2835-isp bcm2835-isp: Device node stats[2] registered as /dev/video23
[   14.352570] bcm2835-isp bcm2835-isp: Register output node 0 with media controller
[   14.352578] bcm2835-isp bcm2835-isp: Register capture node 1 with media controller
[   14.352583] bcm2835-isp bcm2835-isp: Register capture node 2 with media controller
[   14.352588] bcm2835-isp bcm2835-isp: Register capture node 3 with media controller
[   14.352740] bcm2835-isp bcm2835-isp: Loaded V4L2 bcm2835-isp
[   14.358102] cfg80211: Loading compiled-in X.509 certificates for regulatory database
[   14.364597] bcm2835-codec bcm2835-codec: Device registered as /dev/video18
[   14.364629] bcm2835-codec bcm2835-codec: Loaded V4L2 image_fx
[   14.367328] bcm2835-codec bcm2835-codec: Device registered as /dev/video31
[   14.367356] bcm2835-codec bcm2835-codec: Loaded V4L2 encode_image
[   14.375512] Loaded X.509 cert 'benh@debian.org: 577e021cb980e0e820821ba7b54b4961b8b4fadf'
[   14.375838] Loaded X.509 cert 'romain.perier@gmail.com: 3abbc6ec146e09d1b6016ab9d6cf71dd233f0328'
[   14.376135] Loaded X.509 cert 'sforshee: 00b28ddf47aef9cea7'
[   14.376420] Loaded X.509 cert 'wens: 61c038651aabdcf94bd0ac7ff06c7248db18c600'
[   14.385563] Bluetooth: HCI UART driver ver 2.3
[   14.385586] Bluetooth: HCI UART protocol H4 registered
[   14.385665] Bluetooth: HCI UART protocol Three-wire (H5) registered
[   14.387256] hci_uart_bcm serial0-0: supply vbat not found, using dummy regulator
[   14.387418] hci_uart_bcm serial0-0: supply vddio not found, using dummy regulator
[   14.387850] Bluetooth: HCI UART protocol Broadcom registered
[   14.502068] brcmfmac: F1 signature read @0x18000000=0x15264345
[   14.509955] brcmfmac: brcmf_fw_alloc_request: using brcm/brcmfmac43455-sdio for chip BCM4345/6
[   14.510335] usbcore: registered new interface driver brcmfmac
[   14.743814] Bluetooth: hci0: BCM: chip id 107
[   14.744192] Bluetooth: hci0: BCM: features 0x2f
[   14.745415] Bluetooth: hci0: BCM4345C0
[   14.745431] Bluetooth: hci0: BCM4345C0 (003.001.025) build 0000
[   14.756738] Bluetooth: hci0: BCM4345C0 'brcm/BCM4345C0.raspberrypi,4-model-b.hcd' Patch
[   14.864802] brcmfmac: brcmf_c_process_txcap_blob: no txcap_blob available (err=-2)
[   14.865375] brcmfmac: brcmf_c_preinit_dcmds: Firmware: BCM4345/6 wl0: Aug 29 2023 01:47:08 version 7.45.265 (28bca26 CY) FWID 01-b677b91b
[   15.315494] pinctrl-bcm2835 fe200000.gpio: pin gpio4 already requested by onewire@0; cannot claim for 1-0014
[   15.315511] pinctrl-bcm2835 fe200000.gpio: error -EINVAL: pin-4 (1-0014)
[   15.315518] pinctrl-bcm2835 fe200000.gpio: error -EINVAL: could not request pin 4 (gpio4) from group gpio4 on device pinctrl-bcm2711
[   15.315525] Goodix-TS 1-0014: Error applying setting, reverse things back
[   15.487757] Bluetooth: hci0: BCM: features 0x2f
[   15.489022] Bluetooth: hci0: BCM43455 37.4MHz Raspberry Pi 3+-0190
[   15.489029] Bluetooth: hci0: BCM4345C0 (003.001.025) build 0382
[   15.489276] w1_master_driver w1_bus_master1: w1_search: max_slave_count 64 reached, will continue next search.
[   20.411881] Bluetooth: BNEP (Ethernet Emulation) ver 1.3
[   20.411900] Bluetooth: BNEP filters: protocol multicast
[   20.411913] Bluetooth: BNEP socket layer initialized
[   20.415557] Bluetooth: MGMT ver 1.23
[   20.447853] NET: Registered PF_ALG protocol family
[   21.141945] Bluetooth: RFCOMM TTY layer initialized
[   21.141973] Bluetooth: RFCOMM socket layer initialized
[   21.141992] Bluetooth: RFCOMM ver 1.11
[   24.233550] bcmgenet fd580000.ethernet: configuring instance for external RGMII (RX delay)
[   24.234247] bcmgenet fd580000.ethernet eth0: Link is Down
[   24.248820] brcmfmac: brcmf_cfg80211_set_power_mgmt: power save enabled
[   30.592917] ieee80211 phy0: brcmf_cfg80211_reg_notifier: Firmware rejected country setting
[   61.214306] w1_master_driver w1_bus_master1: Family 0 for 00.800000000000.8c is not registered.
[   88.881504] input: M720 Triathlon Keyboard as /devices/virtual/misc/uhid/0005:046D:B015.0004/input/input10
[   88.883595] input: M720 Triathlon Mouse as /devices/virtual/misc/uhid/0005:046D:B015.0004/input/input11
[   88.884071] hid-generic 0005:046D:B015.0004: input,hidraw3: BLUETOOTH HID v0.13 Keyboard [M720 Triathlon] on 2c:cf:67:f3:4c:06
[   89.566344] input: Logitech M720 Triathlon Multi-Device Mouse as /devices/virtual/misc/uhid/0005:046D:B015.0004/input/input13
[   89.566792] logitech-hidpp-device 0005:046D:B015.0004: input,hidraw3: BLUETOOTH HID v0.13 Keyboard [Logitech M720 Triathlon Multi-Device Mouse] on 2c:cf:67:f3:4c:06
[   89.588448] logitech-hidpp-device 0005:046D:B015.0004: HID++ 4.5 device connected.
[  118.604659] w1_master_driver w1_bus_master1: Family 0 for 00.400000000000.46 is not registered.
root1@raspberrypi:~ $ sudo dmesg ^C
root1@raspberrypi:~ $ 
