...
- [Обновление, удаление и добавление данных](#Обновление-данных)
...
Секционирование - две записи попадают в одну секцию, если их значения по выбранному полю (или нескольким) совпадают. Фугкция будет работать не со всем окнос, а с определенной секцией. Секционирование выполняется с помощью оператора `PARTITION BY`
