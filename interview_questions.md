...
__Партиционирование__ - Разделение данных внутри одной базы на части. (партиции). Данные таблицы разделяются по определенному критерию (например, по дате или диапазону значений).
