...
`netstat` - проверить, какие порты открыты на компьютере или сервере
Monkey patch (обезьяний патч) - подмена методов и значений атрибутов классов программы во время её выполнения 
